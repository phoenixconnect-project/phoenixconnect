...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Phoenixconnect " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"phoenixconnect.io", "101.171.11.131"},   
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"phoenixconnecttools.com", "testnet-seed.phoenixconnecttools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Phoenixconnect is probably already running."), addrBind.ToString().c_str());
        else
